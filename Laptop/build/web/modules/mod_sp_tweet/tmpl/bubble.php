...
//<![CDATA[
	function tmpl<?php echo $uniqid ?>(tweets) {
		...
		for (i = 0; i < tweets.length; i++) {
			...
			output += '<div class="sp-tweet-bubble" style="width: '+ Math.round(100/tweets.length) +'%">';
			output += '<div class="bubble-tl"><div class="bubble-tr"><div class="bubble-tm"></div></div></div>';
			output += '<div class="bubble-l"><div class="bubble-r"><div class="bubble-m">'+ status +'</div></div></div>';
			...
			output += '<div class="author"><a target="<?php echo $target ?>" href="http://twitter.com/'+ tweets[i].user.screen_name +'">'+ tweets[i].user.name +'</a></div>';
